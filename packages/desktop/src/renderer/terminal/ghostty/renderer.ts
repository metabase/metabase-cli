...
/**
 * What the two entry points below need of a Canvas 2D context, rather than the
 * whole of one: a real `CanvasRenderingContext2D` satisfies both structurally,
 * and a test can measure a face or count draws without impersonating a browser.
 */
export interface GhosttyTextMeasurer {
  font: string;
...
export interface GhosttyRenderContext {
