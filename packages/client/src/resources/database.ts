...
export function databaseResource(transport: Transport) {
  ...
  async function list(
    ...
    await transport.require("database.list");
  ...
  async function get(
    ...
    await transport.require("database.get");
  ...
  async function schemas(id: number, options: RequestOptions = {}): Promise<ListResult<string>> {
    await transport.require("database.schemas");
  ...
  async function schemaTables(
    ...
    await transport.require("database.schemaTables");
    const data = await transport.requestParsed(
  ...
  async function syncSchema(
    ...
    await transport.require("database.syncSchema");
  ...
  async function rescanValues(
    ...
    await transport.require("database.rescanValues");
