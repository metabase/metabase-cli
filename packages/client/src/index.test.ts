...
const writePath = {
  ...
  TransformIndexCreateInput: pin<TransformIndexCreateInput>(TransformIndexCreateInput),
  TransformIndexUpdateInput: pin<TransformIndexUpdateInput>(TransformIndexUpdateInput),
