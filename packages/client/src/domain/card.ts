...
// The server-side presets `GET /api/card`'s `f` parameter accepts. `database`, `table`,
// `using_model` and `using_segment` each need the matching id in `model_id`.
export const CardListFilter = z.enum([
  "all",
  "mine",
  "bookmarked",
  "database",
