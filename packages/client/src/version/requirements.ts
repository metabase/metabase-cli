...
export const METHOD_REQUIREMENTS = {
  ...
  "gitSync.syncedTree": ["remoteSync"],
  "gitSync.remoteUrl": [],
  "gitSync.branch": [],
  "gitSync.waitForTask": ["remoteSync"],
  "gitSync.worktrees": ["remoteSync"],
  "gitSync.worktree": ["remoteSync"],
  "gitSync.createWorktree": ["remoteSync"],
  "gitSync.deleteWorktree": ["remoteSync"],
  "glossary.list": [],
  "glossary.create": [],
  "glossary.update": [],
  "glossary.delete": [],
  ...
  "metric.query": ["metricDefinitionQuery"],
  "metric.breakoutValues": ["metricDefinitionQuery"],
  "metric.dimensions": ["metricDimensionListing"],
  ...
  "notification.send": [],
  "permission.graph": [],
  "permission.databaseGraph": [],
  "permission.groupGraph": [],
  "pulse.list": [],
  "pulse.get": [],
  "pulse.create": [],
  "pulse.update": [],
  "pulse.archive": [],
  "replacement.checkReplaceSource": ["sourceReplacement"],
  "replacement.replaceSource": ["sourceReplacement"],
  "replacement.replaceModelWithTransform": ["sourceReplacement"],
  "replacement.listRuns": ["sourceReplacement"],
  "replacement.getRun": ["sourceReplacement"],
  "replacement.cancelRun": ["sourceReplacement"],
  "revision.list": [],
  "revision.revert": [],
  "search.query": [],
  "segment.list": [],
  ...
  "transformDagRun.transformRuns": ["transformDagRuns", "transforms"],
  "transformDagRun.cancel": ["transformDagRuns", "transforms"],
  "transformInspector.discover": ["transformInspector"],
  "transformInspector.lens": ["transformInspector"],
  "transformInspector.query": ["transformInspector"],
  ...
  "transformPython.getLibrary": ["pythonLibrary"],
  "transformPython.updateLibrary": ["pythonLibrary"],
  "transformPython.testRun": ["pythonTestRun"],
