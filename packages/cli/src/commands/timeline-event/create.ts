import { TimelineEvent, TimelineEventCreateInput } from "@metabase/client/domain/timeline";
...
export default defineMetabaseCommand({
  ...
  async run({ args, ctx, getClient }) {
    ...
    const created = await client.timelineEvent.create(body);
    renderSummary(
      created,
      timelineEventView,
