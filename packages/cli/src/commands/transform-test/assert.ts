...
import type {
  TestRunAssertion,
  TestRunAssertionSeverity,
} from "@metabase/client/resources/transform-test";

export type Severity = TestRunAssertionSeverity;

export type AssertionDef = TestRunAssertion;
