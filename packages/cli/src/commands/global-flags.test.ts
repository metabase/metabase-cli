...
describe("hoistGlobalFlags", () => {
  ...
  it("moves a leading list-window flag past the verb chain with its value", () => {
    expect(hoistGlobalFlags(["--limit", "5", "card", "list"])).toEqual([
      "card",
      "list",
      "--limit",
      "5",
  ...
  it("hoists --offset alongside --limit as one run", () => {
    expect(hoistGlobalFlags(["--limit", "5", "--offset", "10", "card", "list"])).toEqual([
      "card",
      "list",
      "--limit",
      "5",
