import { Card, CardCreateInput } from "@metabase/client/domain/card";
...
export default defineMetabaseCommand({
  ...
  async run({ args, ctx, getClient }) {
    ...
    const created = await client.card.create(body);
