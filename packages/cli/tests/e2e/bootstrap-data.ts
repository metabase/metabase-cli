...
export const SeededIds = z.object({
  ...
  financeCollectionId: z.number().int().positive(),
  monthlyRevenueCardId: z.number().int().positive(),
  financeDashboardId: z.number().int().positive(),
  financeDashcardId: z.number().int().positive(),
  tables: z.object({
